...
<?php require("includes/workout_nav.html") ?>

<!---------------------------------------------navigation bar end---------------------------------------------->

<h1>Workout Videos</h1>
<div class="video-container">
  <video id="video1" src="https://www.youtube.com/watch?v=2pLT-olgUJs" controls></video>
...
<div class="video chest">
    <h2>Chest Workout </h2>
    <div class="video-container">
        <video controls width="640" height="20">
...
<!-- Add more videos for different body parts -->
