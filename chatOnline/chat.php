                ...
                <div class="ibox chat-view">
                    <div class="ibox-title">
                        <small class="pull-right text-muted"><!-- /// --></small>
                         <?php if($isOwner == true) { ?> <strong><a href="request.php?room_id=<?= $room_id ?>">
							[Request management]</a> - <a href="member.php?room_id=<?= $room_id ?>">[Members management]</a>
							 - <a href="room_options.php?room_id=<?= $room_id ?>">[Room options]</a></strong> <?php } ?>
                    </div>
