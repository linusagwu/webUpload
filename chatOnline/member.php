                    ...
                    <div class="ibox float-e-margins">
						...
						?>
								...
								<div class="social-avatar">
									<small class="text-muted">Joined  <?= $req["join_date"] ?></small>
								</div>
								<div class="social-body">
									<strong><?= $_user["firstName"] . " " . $_user["lastName"]; ?></strong> is currently a member of the group..
								<p></p><hr><p></p>
								<div class="file-option">
									<!--<button class="btn btn-primary btn-rounded btn-sm" onclick="approve_request(<?= $req["user_id"] ?>, <?=  $req["room_id"] ?>)"><i class="fa fa-check"></i> promote to owner </button>-->
	...
	$.ajax({
		...
		success: function(r) {
			if(r.success){
				...
				toastr.error("Unable to approve this member.")
			}
		},
		error: function(){
